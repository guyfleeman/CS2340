 ...
 * @author Kevin
 */
public class SubmitWaterPurityReportController {
    private static final String VIEW_URI = "/frontpage/view/SubmitWaterPurityReport.fxml";

    private static Logger logger;
    private static Parent root;
    private static SubmitWaterPurityReportController purityReportController;

    static {
        logger = Logger.getLogger(SubmitWaterPurityReportController.class.getName());
    }
    ...
    public static void create() {
        try {
            ...
            purityReportController = new SubmitWaterPurityReportController();
    ...
    public static SubmitWaterPurityReportController getPurityReportController() {return purityReportController; }
    ...
    private SubmitWaterPurityReportController() {
    }
